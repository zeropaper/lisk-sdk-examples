...
class Account extends BaseEntity {
    ...
    constructor(adapter, defaultFilters = {}) {
        ...
        /* The filter below is added manually by us, in order to use it in the RegisterPackageTransaction.
         * It filters the existing accounts after a defined package name, if the property is present in the accounts asset field.
         */
